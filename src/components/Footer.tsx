...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#121218] text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Marketplace</h3>
            <ul className="space-y-3">
              <li><Link to="/deals" className="text-gray-400 hover:text-white transition-colors">Affiliate Offers</Link></li>
              <li><Link to="/networks" className="text-gray-400 hover:text-white transition-colors">Networks</Link></li>
              <li><Link to="/offers" className="text-gray-400 hover:text-white transition-colors">Tools & Software</Link></li>
        ...
        <div className="mt-12 pt-6 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">© {currentYear} Twello, Inc. All rights reserved.</p>
